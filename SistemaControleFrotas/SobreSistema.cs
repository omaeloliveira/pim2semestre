...
{
    partial class SobreSistema : MetroFramework.Forms.MetroForm
    {
        public SobreSistema()
        {
            InitializeComponent();
        ...
        private void SobreSistema_Load(object sender, EventArgs e)
        {
            if(this.Theme == MetroFramework.MetroThemeStyle.Dark)
            {
                labelCompanyName.ForeColor = labelCopyright.ForeColor = labelProductName.ForeColor = labelVersion.ForeColor = Color.White;
